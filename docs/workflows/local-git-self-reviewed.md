...
| **MERGING** | The agent merges the task branch into the repo's base branch. | **The agent** — it advances itself once the merge lands. |
| **COMPLETE** | Terminal. The change is merged locally. | — |
