You are in the **PLANNING** phase of the `github-peer-reviewed` workflow. Collect requirements. Produce a plan for the implementation. Do the work this phase calls for and then hand back — **don't start work that belongs to a later phase.**
